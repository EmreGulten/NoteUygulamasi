...
namespace MyEvernote.Web.Controllers
{
    ...
    public class CommentController : Controller
    {
        ...
        public ActionResult ShowNoteComments(int? id)
        {
            ...
            Note note = noteManager.Find(x => x.Id == id); // 2 kere sorgu döndürür

     /*       Note note = noteManager.ListQueryable().Include("Comments").FirstOrDefault(x => x.Id == id); */// tek sorgu döndürür
